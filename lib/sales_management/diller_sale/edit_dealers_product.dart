...
class EditDealersProduct extends StatefulWidget {
  final String dealerId;
  final List<Map<String, dynamic>> products;
  final Map<String, dynamic> salesData;
  final ValueChanged<Map<String, dynamic>> onUpdate;

  const EditDealersProduct({
    Key? key,
  ...
  @override
  _EditDealersProductState createState() =>
      _EditDealersProductState();
}

class _EditDealersProductState extends State<EditDealersProduct> {
  ...
  Future<void> updateFirestoreOnEdit(Map<String, dynamic> updatedSalesData) async {
    ...
    final DocumentReference dealerRef = FirebaseFirestore.instance
        .collection('collection name')
        .doc(userId)
        .collection('dealers')
        .doc(widget.dealerId);
    ...
    final DocumentSnapshot dealerDoc = await dealerRef.get();
    double existingDealerDue = (dealerDoc.exists && dealerDoc['dealers_due'] != null)
        ? (dealerDoc['dealers_due'] as num).toDouble()
        : 0.0;

    double updatedDealerDue = existingDealerDue + dueDifference; 
